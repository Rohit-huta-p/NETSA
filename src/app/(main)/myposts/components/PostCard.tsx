...
import { Drama, Briefcase, Trash2, Share2, Edit, BarChart2, Heart, MessageCircle, Send, Eye } from "lucide-react";
...
export function PostCard({ post }: PostCardProps) {
    ...
    const href = `/${post.postType}s/${post.id}`;
    ...
    return (
        <Link href={href} className="group block">
            <Card className={cn(
                "shadow-sm hover:shadow-md transition-shadow duration-300 group-hover:bg-muted/50"
            )}>
