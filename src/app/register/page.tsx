    ...
    <main className="flex flex-col items-center justify-center min-h-screen p-4 sm:p-6 md:p-8 bg-background">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
        <Link href="/register/artist" className="group">
          <Card className="h-full hover:border-primary transition-colors duration-300 hover:shadow-lg">
            <CardHeader className="items-center text-center">
              ...
              <CardTitle className="text-2xl font-bold text-primary">Register as an Artist</CardTitle>
              <CardDescription>
                Create your portfolio, find gigs, and connect with the industry.
              </CardDescription>
            </CardHeader>
            <CardContent>
                <div className="text-primary font-bold flex items-center justify-center group-hover:underline">
        ...
        <Link href="/register/organizer" className="group">
          <Card className="h-full hover:border-secondary transition-colors duration-300 hover:shadow-lg">
            <CardHeader className="items-center text-center">
              <div className="p-4 bg-secondary/10 rounded-full inline-block mb-4">
                <Users className="w-10 h-10 text-secondary" />
              </div>
              <CardTitle className="text-2xl font-bold text-secondary">Register as an Organizer</CardTitle>
              <CardDescription>
                Post opportunities, discover talent, and manage your events.
              </CardDescription>
            </CardHeader>
            <CardContent>
                 <div className="text-secondary font-bold flex items-center justify-center group-hover:underline">
