...
export function ProfileHeader() {
  ...
  const stats = [
    { value: "47", label: "Events Attended" },
    { value: "12", label: "Events Hosted" },
    { value: "234", label: "Connections" },
  ]

  const skills = ["Contemporary", "Hip-Hop", "Ballet", "Jazz", "Choreography"];
            ...
            <div>
                ...
                <div className="flex items-center gap-2 mt-2 text-muted-foreground">
                 ...
                 <p className="mt-4 max-w-prose text-muted-foreground">
                    Professional dancer and choreographer passionate about contemporary movement and community building.
                </p>
            </div>
