...
const profileFormSchema = z.object({
    ...
    remoteWorkOk: z.boolean().optional(),
...
export function EditProfileForm({ user }: EditProfileFormProps) {
  ...
  const form = useForm<ProfileFormValues>({
    ...
    defaultValues: {
        ...
        remoteWorkOk: user.role === 'artist' ? user.remoteWorkOk : undefined,
        hourlyRate: user.role === 'artist' ? user.hourlyRate : undefined,
        currency: user.role === 'artist' ? user.currency : '',
        preferredCities: user.role === 'artist' ? user.preferredCities : [],
        portfolioLinks: user.role === 'artist' ? user.portfolioLinks : '',
        resumeUrl: user.role === 'artist' ? user.resumeUrl : '',
        socialMedia: {
